...
class _SeniorCheckInFlowState extends State<SeniorCheckInFlow>
  ...
  Future<void> _nextStep() async {
    ...
    if (_currentStep < _totalSteps - 1) {
      ...
      if (gamesProvider.isEnabled) {
        ...
        // Skip brain exercise, persist data and go to success
  ...
  void _onBrainExerciseDecided(bool wantsToPlay) async {
    ...
    // Persist check-in data before showing success
    await _persistCheckIn();
  ...
  Future<void> _persistCheckIn() async {
    ...
    try {
      ...
      // Don't rethrow - still show success screen but with error message
    }
  }
